...
const Store = () => (
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 'auto', padding: '32px 0', textAlign: 'center' }}>
    ...
    <h2 style={{ fontFamily: 'var(--display)', fontSize: 'clamp(40px,8vw,72px)', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '-.01em', lineHeight: .92, marginBottom: 16 }}>
      Leve a estrada <span style={{ color: 'var(--accent)' }}>com você.</span>
    </h2>
    ...
    <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
      <a className="btn-primary" href={STORE_URL} target="_blank" rel="noopener noreferrer" style={{ gap: 10, padding: '16px 28px' }}>
        <ShoppingBag size={18} /> Acessar a loja <ExternalLink size={14} />
      </a>
      <a className="btn-outline" href={WA_URL} target="_blank" rel="noopener noreferrer" style={{ gap: 10, padding: '15px 26px' }}>
